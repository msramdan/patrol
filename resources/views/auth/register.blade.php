            ...
            <div class="container vh-100">
                <div class="welcome-area">
                    <div class="bg-image bg-image-overlay"
                        style="background-image: url(template/assets/images/login/pic3.jpg);"></div>
                    <div class="join-area">
                        <div class="started">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-3 input-group input-group-icon">
                                ...
                                <input id="name" type="text"
                                    ...
                                    value="{{ old('name') }}" required autocomplete="off" placeholder="Nama">
                                @error('name')
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="javascript:void(0);" class="text-light text-center d-block">Sudah punya akun
                                ?</a>
                            <a href="{{ route('login') }}" class="btn-link d-block ms-3 text-underline">Masuk di
                                sini</a>
                        </div>
                    </div>
                </div>
