        ...
        <div class="content-body">
            <div class="container vh-100">
                <div class="welcome-area">
                    <div class="bg-image bg-image-overlay" style="background-image: url(assets/images/login/pic4.jpg);"></div>
                    <div class="join-area">
                        <div class="started">
                        ...
                        <div class="social-box">
                            ...
                            <div class="d-flex justify-content-between">
                                <img src="{{ asset('template') }}/assets/images/icons/facebook.png" alt="/">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <a href="{{ route('register') }}" class="btn-link d-block ms-3 text-underline">Signup here</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from soziety.dexignzone.com/xhtml/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Aug 2023 02:37:08 GMT -->
